<template>
  <span class="tag-badge clickable" :class="specialTagClass(tag)" @click.stop="onTagClick(tag)">
...
<script setup>
import { tagTr, specialTagClass, onTagClick, tagItems, tagCharacters, S } from '../store/codexStore'
